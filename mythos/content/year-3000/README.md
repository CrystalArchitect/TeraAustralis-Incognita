...
## Locks
- Year 3000 = **Imagine only** (no lyrics, not a schedule)
...
## Files (this tree)
Markdown bridge + research matrices. Heavy PDFs/PNGs live on desk `starship-year3000/`, CVSC twin, Drive CrystalCore-Grok-Build, and Notion Analyst.
