...
**Belt:** Vision / study-layer only — not Built outreach, not system proof.
**Version:** 8.3 · Canonical 39 Sealed · Seal: M.A.G.E.

Do not load the 500MB BOOK dump into a small VM. Prefer per-folio files under `folios/`. See `folios/00-index.md` and `folios/PRESENT-MISSING.md`.
